...
contract LotteryTableDeployer is ILotteryTableDeployer{
    ...
    internal returns (address table) {
        ...
        table = address(new LotteryTable{salt: keccak256(abi.encode(factory, creator, amount, minPPL, maxPPL, coolDownTime, gameTime, bankerCommission, referralCommission, bankerWallet))}());
        delete params;
    }
